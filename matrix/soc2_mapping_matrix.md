...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **CC6.1** | Security / Logical Access | The entity restricts logical access to software, data, and infrastructure. | Implemented | `configs/aws_iam_policy.json` | Low | Periodic quarterly review enforced (Target: 2026-10-01) |
